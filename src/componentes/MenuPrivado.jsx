                            ...
                            {autenticacao &&
                                <li className="nav-item dropdown">
                                    ...
                                    <ul className="dropdown-menu">
                                        <li><NavLink className="dropdown-item" to="portoes">Portoes</NavLink></li>
                                        <li><NavLink className="dropdown-item" to="modelos">Modelos</NavLink></li>
                                        <li><NavLink className="dropdown-item" to="carros">Carros</NavLink></li>
                                    </ul>
                                </li>
                            }
                            <li className="nav-item dropdown">
