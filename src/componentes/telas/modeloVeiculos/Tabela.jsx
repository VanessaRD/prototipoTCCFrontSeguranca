...
function Tabela() {
    ...
    return (
        <div style={{ padding: '20px' }}>
            ...
            <button type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEdicaoModelo"
                onClick={() => {
            ...
            {listaObjetos.length === 0 && <h1>Nenhum modelo encontrado</h1>}
                                ...
                                <tr key={objeto.codigo}>
                                    <td align="center">
                                        <button className="btn btn-info" title="Editar"
                                            data-bs-toggle="modal" data-bs-target="#modalEdicaoModelo"
                                            onClick={() => {
